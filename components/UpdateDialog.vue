            ...
            <v-card-text>
                <v-container>
                    <v-row>
                        ...
                        <v-col cols="12" sm="12" md="12">
                            <v-text-field v-model="recipe.image_url" label="Url Image*" required></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="12" md="12">
                            <v-textarea v-model="recipe.description" outlined label="Description"></v-textarea>
                        </v-col>
                        ...
                        <v-col cols="12" sm="6" md="6">
                            <v-switch v-model="recipe.isVegetarian" label="Vegetarian"></v-switch>
                        </v-col>
                        <v-divider />
                        <v-col cols="12">
                            <v-subheader>Ingredients</v-subheader>
                            <div v-for="(row, index) in recipe.ingredients" :key="index">
                        ...
                        <v-col cols="12">
                            ...
                            <div v-for="(row, index) in recipe.instructions" :key="index">
